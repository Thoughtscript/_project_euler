            ...
            for p1 in range(0, L, 1):
                ...
                for p2 in range(0, L, 1):
                    ...
                    if check(n, totient):
                        ...
                        print("Ratio: " + str(ratio) + " with prime factors: " + str(pf1) + " * " + str(pf2) + " = " + str(n) + " and totient: " + str(totient))
                        if ratio < lowest:
                            lowest = ratio
                            lowest_n = n
                            print("New lowest ratio found: " + str(ratio) + " with prime factors: " + str(pf1) + " * " + str(pf2) + " = " + str(n) + " and totient: " + str(totient))
